...
| R9 | Every task that adds behaviour leaves a row — the coverage half of ledger maintenance; the decay half was answered in Round 25 (3/3, no proof went stale across six tickets) | open | — | docs/validation-log.md |
